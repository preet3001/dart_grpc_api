...
class AllItemsOfCategory extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AllItemsOfCategory', createEmptyInstance: create)
    ...
    ..aOM<Items>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'items', subBuilder: Items.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  Items get items => $_getN(1);
  @$pb.TagNumber(2)
  set items(Items v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasItems() => $_has(1);
  @$pb.TagNumber(2)
  void clearItems() => clearField(2);
  @$pb.TagNumber(2)
  Items ensureItems() => $_ensure(1);
}
