...
const AllItemsOfCategory$json = const {
  ...
  '2': const [
    ...
    const {'1': 'items', '3': 2, '4': 1, '5': 11, '6': '.Items', '10': 'items'},
  ],
};

/// Descriptor for `AllItemsOfCategory`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List allItemsOfCategoryDescriptor = $convert.base64Decode('ChJBbGxJdGVtc09mQ2F0ZWdvcnkSHgoKY2F0ZWdvcnlJZBgBIAEoBVIKY2F0ZWdvcnlJZBIcCgVpdGVtcxgCIAEoCzIGLkl0ZW1zUgVpdGVtcw==');
